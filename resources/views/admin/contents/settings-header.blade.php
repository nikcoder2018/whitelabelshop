...
<div class="row">
    <div class="col-md-8">
        <div class="card" id="card-add-category">
            ...
            <div class="card-body">
                <form action="{{route('settings.header')}}" id="form-save-script" method="POST">
                    @csrf 
                    <div class="form-group">
                        <label for="input-slug">Javascript</label>
                        <textarea name="header_scripts" cols="30" rows="15" class="form-control">{!!$header_scripts!!}</textarea>
                    </div>
