...
<section class="card">
    <header class="card-header">
        ...
        <span class="pull-right">
            <a data-toggle="modal" href="#myModal" class=" btn btn-success btn-sm"> Add New Vendor</a>
        </span>
    </header>
    <div class="card-body">
        <div class="row">
            ...
            <form action="{{route('vendors.store')}}" id="form-add-vendor" method="POST">
                ...
                <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="shopname" class="form-control" id="input-shop" placeholder="Enter shopname" required>
                        </div>
                        <div class="form-group">
